...
public class EntityManager<E> implements DbContext<E> {
    ...
    private boolean doUpdate(E entity, long idColumn) throws IllegalAccessException, SQLException {
        ...
        String updateQuery = String.format("UPDATE %s SET %s WHERE id = %d", tableName,
                String.join(",", setStatements), idColumn);
    ...
    private void fillField(Field declaredField, ResultSet resultSet, E entity) throws SQLException, IllegalAccessException {
        ...
        if(type == int.class || type == Integer.class){
            ...
            declaredField.set(entity, intValue);
    ...
    private Field getIdColumn(Class<?> clazz) {
        ...
        return Arrays.stream(clazz.getDeclaredFields()).filter(f -> f.isAnnotationPresent(Id.class))
